...
#KNN - Omit NA - Scale ABV/IBU
set.seed(877)
splitpale = .70
beerbrew_sample_NA_Z <- sample(1:dim(beers_IPAALE_NA_Z)[1],round(splitpale * dim(beers_IPAALE_NA_Z)[1]))
...
# Using only the IBU and ABV values from both the training and test sets
# I use the beer style as the class against which the knn will search.
knnbeer_Z <- knn(knn_train_beers_na_Z[,1:2],knn_test_beers_na_Z[,1:2],cl=knn_train_beers_na_Z$Class,k=24,prob = TRUE)
# The confusion matrix is used for calibrating the output of a model and examining all possible outcomes of the predictions
ipamatrix <- confusionMatrix(table(knnbeer_Z,knn_test_beers_na_Z$Class))
ipamatrix
...
set.seed(877)
splitpale = .70
beerbrew_sample_PMM_Z <- sample(1:dim(beers_IPAALE_PMM_Z)[1],round(splitpale * dim(beers_IPAALE_PMM_Z)[1]))
...
# Using only the IBU and ABV values from both the training and test sets
# I use the beer style as the class against which the knn will search.
knnbeer_PMM_Z <- knn(knn_train_beers_PMM_Z[,1:2],knn_test_beers_PMM_Z[,1:2],cl=as.factor(knn_train_beers_PMM$Class),k=24,prob = TRUE)
# The confusion matrix is used for calibrating the output of a model and examining all possible outcomes of the predictions
ipamatrix <- confusionMatrix(table(knnbeer_PMM_Z,as.factor(knn_test_beers_PMM_Z$Class)))
ipamatrix
...
set.seed(877)
splitpale = .70
beerbrew_sample_CLASS <- sample(1:dim(beers_IPAALE_CLASS)[1],round(splitpale * dim(beers_IPAALE_CLASS)[1]))
...
set.seed(877)
splitpale = .70
beerbrew_sample_CLASS_Z <- sample(1:dim(beers_IPAALE_CLASS_Z)[1],round(splitpale * dim(beers_IPAALE_CLASS_Z)[1]))
...
# Using only the IBU and ABV values from both the training and test sets
# I use the beer style as the class against which the knn will search.
knnbeer_CLASS_Z <- knn(knn_train_beers_CLASS_Z[,1:2],knn_test_beers_CLASS_Z[,1:2],cl=as.factor(knn_train_beers_CLASS_Z$Class),k=24,prob = TRUE)
# The confusion matrix is used for calibrating the output of a model and examining all possible outcomes of the predictions
ipamatrix <- confusionMatrix(table(knnbeer_CLASS_Z,as.factor(knn_test_beers_CLASS_Z$Class)))
ipamatrix
...
table(knn_train_beers_CLASS_Z$Class,classifications)
CM = confusionMatrix(table(knn_train_beers_CLASS_Z$Class,classifications))
